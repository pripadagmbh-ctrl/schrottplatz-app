...
export const KATALOG_SPECS: PileSpec[] = [
  ...
  { materialId: "plastic", massKg: 160, kind: "box", dims: [1.1, 0.75, 2.2], bau: "kleinfahrzeug", name: "Jetski", zusammensetzung: [{ materialId: "plastic", anteil: 0.58 }, { materialId: "steel", anteil: 0.24 }, { materialId: "alu", anteil: 0.1 }, { materialId: "copper", anteil: 0.08 }] },
  ...
  { materialId: "steel", massKg: 95, kind: "box", dims: [0.7, 1.05, 1.9], bau: "kleinfahrzeug", name: "Motorroller (komplett)", zusammensetzung: [{ materialId: "steel", anteil: 0.58 }, { materialId: "plastic", anteil: 0.2 }, { materialId: "alu", anteil: 0.12 }, { materialId: "tires", anteil: 0.06 }, { materialId: "copper", anteil: 0.04 }] },
