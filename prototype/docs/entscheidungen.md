...
| E-051 | Der Motor wird aus einzelnen Zündungen gerechnet (`audio/diesel.ts`), nicht aus einem Oszillator | Man hört ihn neunzig Prozent der Spielzeit. Ein Sägezahn bei 48 Hz ist ein Synthesizerton; ein Diesel klingt, weil er schlägt, ungleichmäßig und mit last­abhängigem Nageln. Als Schleife über einen Arbeitszyklus kostet er im Betrieb weniger als vorher | Aufnahme eines echten Motors als Schleife (Lizenz, immer derselbe Motor, kein Lastverhalten) |
