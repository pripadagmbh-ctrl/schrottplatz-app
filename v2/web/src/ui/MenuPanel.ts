 ...
 */
export interface MenuActions { onNewGame(): void; onExport(): void; onImport(file: File): void; onToggleMute(): boolean }
...
export class MenuPanel {
  ...
  constructor(parent: HTMLElement, i18n: Record<string, unknown>, muted: boolean, private readonly actions: MenuActions) {
    const t = makeT(i18n);
    ...
    this.panel.append(head, this.newBtn, exp, imp, this.muteBtn, file);
