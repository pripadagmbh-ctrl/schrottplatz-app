 ...
 *
 * `src/` ist von diesem Werkzeug UNBERÜHRT. Gerechnet und gemessen wird in
 * `saeulenrechnung.ts`; hier steht nur das Blatt. Die Anlenkungsrechnung dort
...
/*
 * Die Rechnung steht seit dem 15.09.2026 in `saeulenrechnung.ts` — dasselbe
 * Muster wie `zahnformen.ts` neben `zahnknick.ts`. Das Anlenkungsblatt
 * benutzt dieselbe Quelle.
 */
import {
  SAEULE_HEUTE,
  SAEULENROHR,
