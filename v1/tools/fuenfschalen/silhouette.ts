 ...
 *
 * Aufruf:  npx vite-node tools/fuenfschalen/silhouette.ts
 * Ergebnis: docs/f5-greifer-silhouette.svg
 *
...
writeFileSync(
  "docs/f5-greifer-silhouette.svg",
  blatt(
    breite,
    hoehe,
...
console.log(`docs/f5-greifer-silhouette.svg ${breite}x${hoehe}`);
