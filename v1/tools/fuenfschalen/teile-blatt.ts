 ...
 *
 * Aufruf:  npx vite-node tools/fuenfschalen/teile-blatt.ts
 * Ergebnis: docs/f5-greifer-teile.svg
 *
...
console.log(`docs/f5-greifer-teile.svg ${breite}x${hoehe}, ${teile.length} Positionen`);
