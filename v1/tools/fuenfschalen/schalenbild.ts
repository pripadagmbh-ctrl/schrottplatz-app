 ...
 *
 * Aufruf:  npx vite-node tools/fuenfschalen/schalenbild.ts
 * Ergebnis: docs/f5-greiferschale.png
 */
...
console.log("docs/f5-greiferschale.png geschrieben");
for (let k = 0; k <= SCHALEN_ABSCHNITTE; k++)
