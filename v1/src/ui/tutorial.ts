...
export const STEPS: TutorialStep[] = [
  {
    ...
    text:
      ...
      "erscheint dort. Zum Fahren tippst du die Pedale unten in der Mitte an — " +
      "dann fährt derselbe linke Stick. Sieh dich erst " +
      "einmal um — dreh den Oberwagen einmal herum.",
